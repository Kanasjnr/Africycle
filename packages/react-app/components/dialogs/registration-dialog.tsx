...
export function RegistrationDialog() {
  ...
  useEffect(() => {
    async function checkRegistration() {
      ...
      if (!isConnected || !address || !africycle) {
        console.log("Wallet not connected, no address, or africycle not initialized")
      ...
      try {
        ...
        if (!isZeroRole) {
          ...
          console.log("Converted role to human-readable format:", humanReadableRole)
          
          if (humanReadableRole) {
            console.log("User is already registered with role:", humanReadableRole)
  ...
  if (!isConnected || !africycle) {
    console.log("Wallet not connected or africycle not initialized, not showing dialog")
    return null
  }
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <p className="text-xs text-gray-500 text-center">
              This will create a transaction on the Celo blockchain to register your account.
            </p>
          </form>
        </Form>
      </DialogContent>
